...
public class Animal {
	...
	public Animal() {
		...
		// The if statement performs the actions between the { } if the
		// condition is true
		// userInput.hasNextLine() returns true if a String was entered in the
		// keyboard
		if (userInput.hasNextLine()) {

			// this provides you with a way to refer to the object itself
			// userInput.nextLine() returns the value that was entered at the
			// keyboard
	...
	// It is good to use getter and setter methods so that you can protect your
	// data
	...
	public void setUniqueID() {
		...
		// You can cast from one primitive value into another by putting what
		// you want between ( )
		...
		// Byte.toString(bigByte); Short.toString(bigShort);
		...
		// parseShort, parseLong, parseByte, parseFloat, parseDouble,
		// parseBoolean
	...
	public void setFavoriteChar() {
		...
		// Logical operators
		// ! : Converts the boolean value to its right to its opposite form ie.
		// true to false
		// & : Returns true if boolean value on the right and left are both true
		// (Always evaluates both boolean values)
		// && : Returns true if boolean value on the right and left are both
		// true (Stops evaluating after first false)
		// | : Returns true if either boolean value on the right or left are
		// true (Always evaluates both boolean values)
		// || : Returns true if either boolean value on the right or left are
		// true (Stops evaluating after first true)
		// ^ : Returns true if there is 1 true and 1 false boolean value on the
		// right or left
		...
		// The ternary operator assigns one or another value based on a
		// condition
		int whichIsBigger = (50 > randomNumber) ? 50 : randomNumber;

		System.out.println("The biggest number is " + whichIsBigger);

		// The switch statement is great for when you have a limited number of
		// values
		// and the values are int, byte, or char unless you have Java 7 which
		// allows Strings
		switch (randomNumber) {
	...
	// Since numberOfAnimals is Static you must set the value using the class
	// name
	...
	protected static String printNumbers(int maxNumbers) {
		...
		while (i < (maxNumbers / 2)) {
			...
			// This isn't needed, but if you want to jump out of a loop use
			// break
			if (i == (maxNumbers / 2))
				break;
	...
	protected static void guessMyNumber() {
		...
		// Do while loops are used when you want to execute the code in the
	...
	// With polymorphism we can refer to any Animal and yet use overridden
	// methods
	...
	// This method can except Strings that can be stored in the String array
	// args when it is executed
